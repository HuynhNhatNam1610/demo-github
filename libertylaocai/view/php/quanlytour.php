...
$data = getTourData($conn, $id_dichvu, $id_ngonngu);
$tours = $data['tours'];
                ...
                <div class="section-content">
                    <form class="form-grid" id="descriptionForm">
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="content_vi" rows="8" placeholder="Nhập mô tả dịch vụ, mỗi đoạn văn cách nhau bằng dòng trống..."><?php echo $tour_description ? htmlspecialchars($tour_description['content']) : ''; ?></textarea>
                        </div>
                        ...
                        <div class="form-group full-width">
                            ...
                            <textarea name="content_en" rows="8" placeholder="Enter service description, each paragraph separated by a blank line..."><?php 
