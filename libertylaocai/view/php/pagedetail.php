...
$translations = [
    1 => [ // Tiếng Việt
        ...
        'loading_text' => 'Đang xử lý yêu cầu...'
    ],
    2 => [ // Tiếng Anh
        'title' => 'Book an Event',
        ...
        'loading_text' => 'Processing request...'
    ]
];
...
if (!empty($menuType)) {
    $menus = getMenusByTypeAndLanguage($menuType, $languageId);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
                        ...
                        <div class="desc-section">
                            ...
                            <form id="quickBookingForm" action="/libertylaocai/user/submit" method="POST" enctype="multipart/form-data" style="margin-top: 30px;">
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-submit" id="submitBookingBtn">
                                        <?= htmlspecialchars($trans['submit_button']) ?>
    ...
    <button class="quick-booking-btn" onclick="showTab('booking')">
    ...
    <div id="fullScreenLoader" class="full-screen-loader" style="display: none;">
        <div class="loader-content">
            ...
            <p><?= htmlspecialchars($trans['loading_text']) ?></p>
        </div>
    </div>
