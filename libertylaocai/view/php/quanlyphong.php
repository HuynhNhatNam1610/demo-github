...
$stats = $data['stats'];
$room_type_stats = $data['room_type_stats'];
?>
<!DOCTYPE html>
<html lang="vi">
<head>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="status-badge status-<?php echo $room['status']; ?>">
                                        <?php 
                                        switch($room['status']) {
                                            case 'available': echo 'Trống'; break;
                                            case 'reserved': echo 'Đã đặt'; break;
                ...
                <div class="form-group">
                    ...
                    <select id="id_loaiphong" name="id_loaiphong" class="form-control" required>
                        ...
                        <option value="<?php echo $type['id']; ?>">
                            <?php echo htmlspecialchars($type['name']); ?> - <?php echo number_format($type['price']); ?> VNĐ
    ...
    <div id="editRoomTypeModal" class="modal">
        <div class="modal-content" style="max-width: 800px;">
            ...
            <form method="POST" enctype="multipart/form-data" id="editRoomTypeForm">
                ...
                <div class="form-group">
                    <label>Thêm Ảnh Mới (Tùy chọn, tối đa 4 ảnh):</label>
                    <div class="image-upload-container">
                        <div class="form-row">
                            <div class="form-group">
                                <label>Ảnh 1:</label>
                                <input type="file" id="edit_room_type_image1" name="new_images[]" accept="image/*" onchange="previewImage(this, 'edit-new-image-preview-1')">
                                <div id="edit-new-image-preview-1" class="image-preview-single"></div>
                            </div>
                            <div class="form-group">
                                <label>Ảnh 2:</label>
                                <input type="file" id="edit_room_type_image2" name="new_images[]" accept="image/*" onchange="previewImage(this, 'edit-new-image-preview-2')">
                                <div id="edit-new-image-preview-2" class="image-preview-single"></div>
                            </div>
                            <div class="form-group">
                                <label>Ảnh 3:</label>
                                <input type="file" id="edit_room_type_image3" name="new_images[]" accept="image/*" onchange="previewImage(this, 'edit-new-image-preview-3')">
                                <div id="edit-new-image-preview-3" class="image-preview-single"></div>
                            </div>
                            <div class="form-group">
                                <label>Ảnh 4:</label>
                                <input type="file" id="edit_room_type_image4" name="new_images[]" accept="image/*" onchange="previewImage(this, 'edit-new-image-preview-4')">
                                <div id="edit-new-image-preview-4" class="image-preview-single"></div>
                            </div>
                        </div>
                    </div>
                </div>
