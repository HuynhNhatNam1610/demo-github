...
<head>
    ...
    <title><?php echo htmlspecialchars($getPromotionById['title'] ?? ($languageId == 1 ? 'Khuyến Mãi' : 'Promotion')); ?> - <?php echo $languageId == 1 ? 'Khách Sạn Liberty Lào Cai' : 'Liberty Hotel Lao Cai'; ?></title>
    <link rel="icon" type="image/png" href="/libertylaocai/view/img/logoliberty.jpg">
    <meta name="description" content="<?php echo $languageId == 1 ? 'Xem chi tiết khuyến mãi ' . htmlspecialchars($getPromotionById['title'] ?? 'khuyến mãi') . ' tại khách sạn Liberty Lào Cai với ưu đãi hấp dẫn.' : 'View details of the ' . htmlspecialchars($getPromotionById['title'] ?? 'promotion') . ' at Liberty Hotel Lao Cai with exclusive offers.'; ?>">
