...
//         lienhetour: true, // Append lienhe: true
//       };
...
//   function initClickableServiceLinks() {
//     const serviceLinks = document.querySelectorAll(".service-link, .tour-card");
//     serviceLinks.forEach((link) => {
//       link.style.cursor = "pointer";
//       link.addEventListener("click", (e) => {
//         e.preventDefault();
//         const form = link.closest('form[action="/libertylaocai/user/submit"]');
//         if (form) {
//           form.submit();
//         } else {
//           console.error("No parent form found for service link:", link);
//         }
//       });
//     });
//   }
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  function initContactForm() {
    ...
    form.addEventListener("submit", async (e) => {
      ...
      // Get fullScreenLoader element
      const fullScreenLoader = document.getElementById("fullScreenLoader");
      if (!fullScreenLoader) {
        console.error("Không tìm thấy phần tử fullScreenLoader trong DOM");
        return;
      }

      // Show full-screen-loader
      console.log("Showing full-screen-loader");
      ...
      if (errors.length > 0) {
        showNotification("Validation Error", errors.join("<br>"), "error");
        // Hide full-screen-loader if form is invalid
      ...
      try {
        ...
        console.log("Hiding full-screen-loader");
        fullScreenLoader.style.display = "none";
        submitBtn.disabled = false;
        submitBtn.innerHTML =
          '<span>Send Request</span><i class="fas fa-paper-plane"></i>';
