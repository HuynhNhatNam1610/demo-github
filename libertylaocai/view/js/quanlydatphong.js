...
function updateBookingTable(bookings) {
  ...
  bookings.forEach((booking) => {
    ...
    row.innerHTML = `
            ...
            <td>${new Date(booking.created_at).toLocaleString("vi-VN", {
              day: "2-digit",
              month: "2-digit",
              year: "numeric",
              hour: "2-digit",
            ...
            <td>${
              booking.is_read === 0 ? "Chưa đọc" : "Đã đọc"
            }</td> <!-- Thêm cột trạng thái -->
            <td>
                <button class="btn btn-info btn-small" data-booking='${JSON.stringify(
                  booking
                )}'><i class="fas fa-info-circle"></i></button>
                <button class="btn btn-danger btn-small" onclick="confirmDelete(${
                  booking.id
                }, '${booking.id}')"><i class="fas fa-trash"></i></button>
            </td>
        `;
...
function updateEventTable(events) {
  ...
  events.forEach((event) => {
    ...
    row.innerHTML = `
            ...
            <td>${new Date(event.start_at).toLocaleString("vi-VN", {
              day: "2-digit",
              month: "2-digit",
              year: "numeric",
              hour: "2-digit",
            ...
            <td>
                <button class="btn btn-info btn-small" onclick='openDetailEventModal(${JSON.stringify(
                  event
                )})'><i class="fas fa-info-circle"></i></button>
                <button class="btn btn-danger btn-small" onclick="confirmDeleteEvent(${
                  event.id
                }, '${event.id}')"><i class="fas fa-trash"></i></button>
            </td>
        `;
    tbody.appendChild(row);
  });
...
function updateRestaurantTable(restaurants) {
  ...
  restaurants.forEach((restaurant) => {
    ...
    row.innerHTML = `
            ...
            <td>${new Date(restaurant.start_at).toLocaleString("vi-VN", {
              day: "2-digit",
              month: "2-digit",
              year: "numeric",
              hour: "2-digit",
            ...
            <td>
                <button class="btn btn-info btn-small" onclick='openDetailRestaurantModal(${JSON.stringify(
                  restaurant
                )})'><i class="fas fa-info-circle"></i></button>
                <button class="btn btn-danger btn-small" onclick="confirmDeleteRestaurant(${
                  restaurant.id
                }, '${restaurant.id}')"><i class="fas fa-trash"></i></button>
            </td>
        `;
    tbody.appendChild(row);
  });
...
function confirmDeleteRestaurant(restaurantId, restaurantCode) {
  Swal.fire({
    ...
    if (result.isConfirmed) {
      ...
      const formData = new FormData(
        document.getElementById("deleteRestaurantForm")
      );
...
function updateBarTable(bars) {
  ...
  bars.forEach((bar) => {
    ...
    row.innerHTML = `
            ...
            <td>${new Date(bar.start_at).toLocaleString("vi-VN", {
              day: "2-digit",
              month: "2-digit",
              year: "numeric",
              hour: "2-digit",
            ...
            <td>
                <button class="btn btn-info btn-small" onclick='openDetailBarModal(${JSON.stringify(
                  bar
                )})'><i class="fas fa-info-circle"></i></button>
                <button class="btn btn-danger btn-small" onclick="confirmDeleteBar(${
                  bar.id
                }, '${bar.id}')"><i class="fas fa-trash"></i></button>
            </td>
        `;
    tbody.appendChild(row);
  });
...
function showBookingDetailModal(booking) {
  ...
  document.getElementById("detail_room_type").textContent =
    booking.room_type_name || "Chưa xác định";
  document.getElementById("detail_customer_name").textContent =
    booking.customer_name || "N/A";
  document.getElementById("detail_customer_phone").textContent =
    booking.customer_phone || "N/A";
  document.getElementById("detail_customer_email").textContent =
    booking.customer_email || "N/A";
  document.getElementById("detail_time_come").textContent = new Date(
    booking.time_come
  ...
  document.getElementById("detail_time_leave").textContent = new Date(
    booking.time_leave
  ).toLocaleString("vi-VN", {
    day: "2-digit",
    month: "2-digit",
  ...
  document.getElementById("detail_number_people").textContent = `${
    booking.number_adult + booking.number_children
  } (${booking.number_adult} người lớn, ${booking.number_children} trẻ em)`;
...
function showRestaurantDetailModal(restaurant) {
  ...
  document.getElementById("detail_restaurant_location").textContent =
    restaurant.location || "Chưa xác định";
  document.getElementById("detail_restaurant_customer_name").textContent =
    restaurant.customer_name || "N/A";
  document.getElementById("detail_restaurant_customer_phone").textContent =
    restaurant.customer_phone || "N/A";
  document.getElementById("detail_restaurant_customer_email").textContent =
    restaurant.customer_email || "N/A";
  document.getElementById("detail_restaurant_start_at").textContent = new Date(
    restaurant.start_at
  ).toLocaleString("vi-VN", {
    day: "2-digit",
    month: "2-digit",
  ...
  document.getElementById("detail_restaurant_number_people").textContent =
    restaurant.number_people || "N/A";
  document.getElementById("detail_restaurant_occasion").textContent =
    restaurant.occasion || "N/A";
  document.getElementById("detail_restaurant_note").textContent =
    restaurant.note || "N/A";
...
function showBarDetailModal(bar) {
  ...
  document.getElementById("detail_bar_customer_name").textContent =
    bar.customer_name || "N/A";
  document.getElementById("detail_bar_customer_phone").textContent =
    bar.customer_phone || "N/A";
  document.getElementById("detail_bar_customer_email").textContent =
    bar.customer_email || "N/A";
  document.getElementById("detail_bar_start_at").textContent = new Date(
    bar.start_at
  ).toLocaleString("vi-VN", {
    day: "2-digit",
    month: "2-digit",
  ...
  document.getElementById("detail_bar_number_people").textContent =
    bar.number_people || "N/A";
...
function showContactDetailModal(contact) {
  ...
  document.getElementById("detail_contact_customer_name").textContent =
    contact.customer_name || "N/A";
  document.getElementById("detail_contact_customer_phone").textContent =
    contact.customer_phone || "N/A";
  document.getElementById("detail_contact_customer_email").textContent =
    contact.customer_email || "N/A";
  document.getElementById("detail_contact_created_at").textContent = new Date(
    contact.created_at
  ).toLocaleString("vi-VN", {
    day: "2-digit",
    month: "2-digit",
  ...
  document.getElementById("detail_contact_message").textContent =
    contact.message || "N/A";
...
function updateContactTable(contacts) {
  ...
  contacts.forEach((contact) => {
    ...
    row.innerHTML = `
            ...
            <td>${new Date(contact.created_at).toLocaleString("vi-VN", {
              day: "2-digit",
              month: "2-digit",
              year: "numeric",
              hour: "2-digit",
            ...
            <td>
                <button class="btn btn-info btn-small" onclick='openDetailContactModal(${JSON.stringify(
                  contact
                )})'><i class="fas fa-info-circle"></i></button>
                <button class="btn btn-danger btn-small" onclick="confirmDeleteContact(${
                  contact.id
                }, '${contact.id}')"><i class="fas fa-trash"></i></button>
            </td>
        `;
    tbody.appendChild(row);
  });
...
function updateServiceTable(services) {
  ...
  services.forEach((service) => {
    ...
    row.innerHTML = `
            ...
            <td>${new Date(service.created_at).toLocaleString("vi-VN", {
              day: "2-digit",
              month: "2-digit",
              year: "numeric",
              hour: "2-digit",
            ...
            <td>
                <button class="btn btn-info btn-small" onclick='openDetailServiceModal(${JSON.stringify(
                  service
                )})'><i class="fas fa-info-circle"></i></button>
                <button class="btn btn-danger btn-small" onclick="confirmDeleteService(${
                  service.id
                }, '${service.id}')"><i class="fas fa-trash"></i></button>
            </td>
        `;
    tbody.appendChild(row);
  });
...
function showEventDetailModal(event) {
  ...
  document.getElementById("detail_event_type").textContent =
    eventTypeMap[event.type_event] || event.type_event;
  document.getElementById("detail_event_customer_name").textContent =
    event.customer_name || "N/A";
  document.getElementById("detail_event_customer_email").textContent =
    event.customer_email || "N/A";
  document.getElementById("detail_event_customer_phone").textContent =
    event.customer_phone || "N/A";
  document.getElementById("detail_event_hall_name").textContent =
    event.hall_name || "N/A";
  document.getElementById("detail_event_start_at").textContent = new Date(
    event.start_at
  ).toLocaleString("vi-VN");
  document.getElementById("detail_event_end_at").textContent = new Date(
    event.end_at
  ).toLocaleString("vi-VN");
  document.getElementById("detail_event_number_people").textContent =
    event.number_people;
  document.getElementById("detail_event_note").textContent =
    event.note || "N/A";
  document.getElementById("detail_event_budget").textContent = formatCurrency(
    event.budget
  );

  // Xử lý ảnh trong slider
  const swiperWrapper = document.querySelector(
    "#detail_event_images .swiper-wrapper"
  );
  ...
  if (event.images && event.images !== "") {
    ...
    document
      .querySelectorAll('[data-lightbox="event-images"]')
      .forEach((link) => {
...
function showServiceDetailModal(service) {
  try {
    document.getElementById("detail_service_id").textContent =
      service.id || "N/A";
    document.getElementById("detail_service_service").textContent =
      service.service || "N/A";
    document.getElementById("detail_service_customer_name").textContent =
      service.customer_name || "N/A";
    document.getElementById("detail_service_customer_phone").textContent =
      service.customer_phone || "N/A";
    document.getElementById("detail_service_customer_email").textContent =
      service.customer_email || "N/A";
    document.getElementById("detail_service_created_at").textContent =
      service.created_at
        ...
        : "N/A";
    document.getElementById("detail_service_message").textContent =
      service.message || "N/A";
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (
    document.getElementById("restaurant-management").style.display === "block"
  ) {
    fetchRestaurants(1);
  }
