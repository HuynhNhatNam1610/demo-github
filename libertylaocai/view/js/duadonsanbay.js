...
function bookVehicle(vehicleType) {
    ...
    // Có thể thay thế bằng modal hoặc redirect đến form booking
    alert(`Đặt ${vehicleName} thành công! Chúng tôi sẽ liên hệ với bạn sớm nhất.`);
    
    // Hoặc redirect đến trang booking
