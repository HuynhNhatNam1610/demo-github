...
function handleFormSubmit(formId, action) {
    ...
    form.addEventListener("submit", function(e) {
        ...
        // Lấy dữ liệu từ CKEditor nếu form là hotelForm
        if (formId === "hotelForm") {
...
document.addEventListener("DOMContentLoaded", function() {
    // Khởi tạo CKEditor cho description_vi và description_en
    ClassicEditor.create(document.querySelector("#description_vi"), {
        ckfinder: {
